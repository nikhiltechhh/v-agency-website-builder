...
const Footer = () => {
  ...
  <motion.a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 flex items-center justify-center bg-background/10 rounded-lg hover:bg-green-500 transition-colors"
    whileHover={{ scale: 1.1, rotate: 5 }}
    whileTap={{ scale: 0.95 }}
  >
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-4 text-background/70">
              ...
              <p>
                ...
                <br />
                Plot 158C, Addagutta Society, Kukatpally, Telangana, 500085
              </p>
              <p>
                <strong className="text-background">Faridabad:</strong>
                <br />
                Green Field Colony, Hariyana, 121010
              </p>
              <p>
                <strong className="text-background">Visakhapatnam:</strong>
                <br />
                Bhagat Singh Nagar, Near Vizag International Airport, Andhra Pradesh, 530027
              </p>
            </div>
          </motion.div>
        </div>
